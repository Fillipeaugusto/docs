---
title: 'Quickstart'
description: 'Start building awesome documentation in under 5 minutes now'
---
...
<AccordionGroup>
	<Accordion icon="github" title="Clone your docs locally">
		...
		[dashboard](https://dashboard.mintlify.com). To clone the repository locally,
		follow these
	...
	<Accordion icon="rectangle-terminal" title="Preview changes">
		...
		documentation changes locally with this command: ``` npm i -g mintlify ``` 2.
...
<Accordion icon="rocket" title="Push your changes">
	...
	the Github app successfully deployed your changes, you can also manually update
	your docs through our [dashboard](https://dashboard.mintlify.com).
</Accordion>
